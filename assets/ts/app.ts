...
document.addEventListener("DOMContentLoaded", () => {
    ...
    let themeBtnLg = document.getElementById("changeThemeBtnLg") as HTMLButtonElement;
    themeBtnLg.addEventListener("click", changeTheme);
    let changeBtn = document.getElementById("changeButtons") as HTMLButtonElement;
    ...
    mainTable.addEventListener("click", function (event) {
        ...
        if (targetEvent.tagName === "BUTTON") {
            ...
            if (buttonValue === "clear") {
                ...
                calculator.addConstants(constantsArr[buttonValue as keyof typeof constantsArr])
            }
            // for btn +/-
                ...
                calculator.mathPowValue(pow[buttonValue as keyof typeof pow]);
            }
            else if (buttonValue in basePow) {
                calculator.basePowValue(basePow[buttonValue as keyof typeof basePow]);
            }
            else {
    ...
    (document.getElementById("mathFunc") as HTMLDivElement).addEventListener("click", function (event) {
        let func = ["ceil", "floor"]
        let targetEvent = event.target as HTMLButtonElement
        if ((targetEvent).tagName === "BUTTON") {
            const buttonValue = targetEvent.value;
    ...
    interface TrigoFunction {
        [key: string]: string;  // Key is the button value, value is the Math method name
    }
    (document.getElementById("trigonometry") as HTMLDivElement).addEventListener("click", function (event) {
